...
import com.darkmi.phoneremote.biz.PRHander;
import com.darkmi.phoneremote.protocol.MessageCodecFactory;
...
public class InitConnection {
	...
	public IoSession conn() {
		try {
			IoSession session = new MinaUtil().ConnTcpByMina(TestEntity.PhoneRemoteIP,
					TestEntity.PhoneRemotePort, new PRHander(),
