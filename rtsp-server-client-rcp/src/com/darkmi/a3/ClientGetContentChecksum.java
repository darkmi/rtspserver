 ...
 *
 */
public class ClientGetContentChecksum {

	public static void main(String[] args) throws IOException {
		HttpClient httpclient = new DefaultHttpClient();
		HttpPost httppost = new HttpPost("http://192.168.7.134:9090/GetContentChecksum");
		StringBuffer sb = new StringBuffer();
		sb.append("<?xml version=\"1.0\" encoding=\"utf-8\"?>");
		sb.append("<GetContentChecksum ");
		sb.append("providerID=\"comcast.com\" ");
		sb.append("assetID=\"BAAA100000000018377\" ");
		sb.append("volumeName=\"volumeA\" ");
		sb.append("responseURL=\"http://192.168.1.1:8001\" />");
