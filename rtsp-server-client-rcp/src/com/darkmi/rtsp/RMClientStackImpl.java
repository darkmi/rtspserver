 ...
 *
 */
public class RMClientStackImpl implements RtspStack, Runnable {
	...
	private static Logger logger = Logger.getLogger(RMClientStackImpl.class);
	 ...
	 */
	public RMClientStackImpl(String address, int port) throws UnknownHostException {
	...
	public void start() {
		...
		bootstrap.setPipelineFactory(new RMPipelineFactory(this));
		logger.debug("RM Client started and bound to " + bindAddress.toString());
	}
	...
	private class ClientChannelFutureListener implements ChannelFutureListener {
		public void operationComplete(ChannelFuture arg0) throws Exception {
			logger.info("RM Client Stop complete");
		}
	}
