...
/**
 * Description: NGOD规范中的Transport.
 * Copyright (c) 永新视博.
 * @version 1.0  2012-01-09 mxh created.
 *           1.1  2012-01-10 mxh updated.
 */
public class NGODTransport {
	private static Logger logger = LoggerFactory.getLogger(NGODTransport.class);
	 ...
	 */
	public NGODTransport(String transport) {
		transportProtocol = TransportProtocol.None;
		profile = Profile.None;
		lowerTransport = LowerTransport.None;
		deliveryType = DeliveryType.None;
