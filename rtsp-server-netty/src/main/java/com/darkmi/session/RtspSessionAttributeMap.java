...
public interface RtspSessionAttributeMap {
     ...
     * </pre>
     */
    Object getAttribute(RtspSession session, Object key, Object defaultValue);
     ...
     */
    Object setAttribute(RtspSession session, Object key, Object value);
     ...
     * </pre>
     */
    Object setAttributeIfAbsent(RtspSession session, Object key, Object value);
     ...
     */
    Object removeAttribute(RtspSession session, Object key);
     ...
     * </pre>
     */
    boolean removeAttribute(RtspSession session, Object key, Object value);
     ...
     * </pre>
     */
    boolean replaceAttribute(RtspSession session, Object key, Object oldValue, Object newValue);

    /**
     * Returns <tt>true</tt> if this session contains the attribute with
     * the specified <tt>key</tt>.
     */
    boolean containsAttribute(RtspSession session, Object key);

    /**
     * Returns the set of keys of all user-defined attributes.
     */
    Set<Object> getAttributeKeys(RtspSession session);
    
    /**
     * Disposes any releases associated with the specified session.
     * This method is invoked on disconnection.
     */
    void dispose(RtspSession session) throws Exception;
}
