...
public class DiscardClientHandler extends SimpleChannelUpstreamHandler {
	...
	public void handleUpstream(ChannelHandlerContext ctx, ChannelEvent e) throws Exception {
		logger.info("handleUpstream begin {...");
		...
		logger.info("handleUpstream end ...}");
	}

	@Override
	public void channelConnected(ChannelHandlerContext ctx, ChannelStateEvent e) {
		logger.info("channelConnected begin {...");
		// Send the initial messages.
		//generateTraffic(e);
		logger.info("channelConnected end ...}");
	}

	@Override
	public void channelInterestChanged(ChannelHandlerContext ctx, ChannelStateEvent e) {
		logger.info("channelInterestChanged begin {...");
		// Send the initial messages.
		//generateTraffic(e);
		logger.info("channelInterestChanged end ...}");
	}
	...
	public void writeComplete(ChannelHandlerContext ctx, WriteCompletionEvent e) {
		logger.info("writeComplete begin {...");
		//transferredBytes += e.getWrittenAmount();
		logger.info("writeComplete end ...}");
